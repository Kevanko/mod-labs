...
Чтобы сгенерировать **по 50 графов на каждую из 8 формул** (400 всего) для стабильных средних и выбора 8 интересных:

```bash
python3 lab-3.py --batch 50 --eight   # 8 параметров × 50 = 400 графов
```

Альтернативы (полный набор 7×7 параметров):
